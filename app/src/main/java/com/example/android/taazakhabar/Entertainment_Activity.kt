...
class Entertainment_Activity : AppCompatActivity() , NewsItemClicked {
    private lateinit var mAdapter: NewsListAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_entertainment_)
    ...
    override fun onItemClicked(item: News) {
        ...
        customTabsIntent.launchUrl(this@Entertainment_Activity, Uri.parse(item.url))
    }
}
